...
const shots = [
  ...
  { file: '05-隆兴寺全景（东门外）.png', cam: [-1150, 460, -350], tgt: [-760, 40, 300] },
  { file: '06-隆兴寺大悲阁与摩尼殿.png', cam: [-900, 150, 250], tgt: [-760, 45, 340] },
  ...
  { file: '12-荣国府.png', cam: [-1000, 230, 200], tgt: [-600, 35, 560] },
